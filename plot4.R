...
##############################################################################
# STEP 5 - Initialise 2x2 plot window
...
# STEP 6.1 - Create subplot4
with(data_full, plot(DateTime, Global_active_power, type = "l", 
                     xlab = "", ylab = "Global Active Power"))

# STEP 6.2 - Create subplot4
with(data_full, plot(DateTime, Voltage, type = "l", 
                     xlab = "datetime", ylab = "Voltage"))

# STEP 6.3 - Create subplot4
with(data_full, { 
...
# STEP 6.4 - Create subplot4
with(data_full, plot(DateTime, Global_reactive_power, type = "l", 
                     xlab = "datetime", ylab = "Global_reactive_power"))

##############################################################################
# STEP 7 - Close PNG file device 
